...
demoUrl: "https://dotbrains.github.io/set-me-up-docs"
technologies:
  - Shell
  - Python
  - Homebrew
  ...
  - MacOS
  - rcm
image_url: "https://unsplash.com/photos/turned-on-macbook-air-beside-saucer-with-cake-on-table-_yBEyYR8wps"
---

## Introduction

Setting up a dev environment on macOS or Debian Linux? Tedious. Time-consuming. If you've ever dreaded configuring a fresh machine or switching between systems, you know exactly what I'm talking about.

That's why I built `set-me-up`—a project that automates and simplifies the entire setup and maintenance process. It uses a collection of dotfiles and shell scripts organized into modules to handle the grunt work. You get a solid, customizable template that works as-is or can be adapted to your specific needs.
...
The `set-me-up` installer is an universal installer script that is sued to install 'set-me-up' (smu) on a Mac or _debian_ based machines.
