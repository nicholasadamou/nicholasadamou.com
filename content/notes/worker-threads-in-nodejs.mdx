...
image_url: "https://images.unsplash.com/photo-1755181023996-348eb11282ef?ixlib=rb-4.1.0%5C&w=1200&q=80&auto=format&fit=crop"
---
...
The [`worker_threads`](https://nodejs.org/api/worker_threads.html) module was introduced in Node.js v10.5.0 and became stable in Node.js v12. It provides a way to create true parallel execution threads that can share memory with the main thread.
